...
Calculations:
I toggled a pin on my mcu within my main loop, as my polling would be constrained by how fast the main loop can operate, which was 52.8Hz, and then I measured the frequency of the encoder which is 999Hz, and when i performed all the calculations, I found the frequency of how fast my main loop could detect my pulse, and then converted that to rev/s, depending on my 408ppr.
![Figure 1: Polling Differences](images/Note%20Oct%204%2C%202025.jpeg)
Image 1 above displays the calculations for the polling comparison.

![Figure 2: Flowchart with logic flow and interrupts](images/flowchart1.jpeg)
...
### Schematic
![Figure 3: Schematic of the physical circuit](images/schematic2.jpeg)
![Figure 3.5: Schematic of the physical circuit](images/schematic3.jpeg)
...
![Figure 4: Angular Velocity Calculations](images/final_calc1.jpeg)
